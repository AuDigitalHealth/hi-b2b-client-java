...
| **Facade classes** | **26** in **`24.0.0`**; **14** in **`8.0.0`** |
...
- **`24.0.0`** (and **`21.0.0`**, **`17.0.0`**, **`11.0.0`**) exposes all **26** rows above. **`8.0.0`** exposes the rows marked **Yes** in the last column only.
