...
**Audience:** integrators choosing APIs for **`11.0.0`** (**26** facade classes). Setup (Maven Central dependency, keystores, endpoints) is in **`README.md`**.
...
## Quick index - all facade classes (`11.0.0`)
