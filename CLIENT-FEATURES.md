...
**Audience:** integrators choosing APIs for **`1.7.1`** (**26** facade classes). Setup (Maven Central dependency, keystores, endpoints) is in **`README.md`**.
...
## Quick index — all facade classes (`1.7.1`)
