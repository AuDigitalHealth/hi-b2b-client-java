...
import au.net.electronichealth.ns.hi.svc.providerreadproviderorganisation._3_2.*;
...
public class ProviderReadProviderOrganisationClient extends BaseClient_3<ProviderReadProviderOrganisationPortType> {
    ...
    /**
     * @param request the ReadProviderOrganisation request object
     * @return the response from the ProviderReadProviderOrganisation
     * service
     * @throws StandardErrorMsg Executes an Identifier HPI-O search.
