...
import au.net.electronichealth.ns.hi.svc.providermanageprovideradministrativeindividual._3_2.*;
...
public class ProviderManageProviderAdministrativeIndividualClient extends BaseClient_3<ProviderManageProviderAdministrativeIndividualPortType> {
     ...
     *
     * @param request the ManageProviderAdministrativeIndividual request object
     ...
     */
    public final ManageProviderAdministrativeIndividualResponse manageProviderAdministrativeIndividual(ManageProviderAdministrativeIndividual request)
