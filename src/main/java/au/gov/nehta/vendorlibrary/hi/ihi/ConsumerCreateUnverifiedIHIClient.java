...
import au.net.electronichealth.ns.hi.svc.consumercreateunverifiedihi._3_0.ConsumerCreateUnverifiedIHIPortType;
import au.net.electronichealth.ns.hi.svc.consumercreateunverifiedihi._3_0.ConsumerCreateUnverifiedIHIService;
import au.net.electronichealth.ns.hi.svc.consumercreateunverifiedihi._3_0.CreateUnverifiedIHI;
import au.net.electronichealth.ns.hi.svc.consumercreateunverifiedihi._3_0.CreateUnverifiedIHIResponse;
import au.net.electronichealth.ns.hi.svc.consumercreateunverifiedihi._3_0.StandardErrorMsg;
...
/**
 * An implementation of a Healthcare Identifiers (HI) Individual Healthcare Identifier (IHI) create unverified client.
 * This class may be used to connect to the Medicare HI Service for Consumer Create Unverified IHI (3.0.2) operations.
 */
public class ConsumerCreateUnverifiedIHIClient extends BaseClient_3<ConsumerCreateUnverifiedIHIPortType> {

    /**
     * Constructor which creates a new ConsumerCreateUnverifiedIHIClient with an endpoint and an SSL Socket Factory.
     *
     * @param serviceEndpoint         the Web Service endpoint for the Medicare HI Service interface (Mandatory)
     * @param individualQualifiedId   The qualified user ID for connecting to the ConsumerCreateUnverifiedIHI service (Mandatory)
     * @param productHeader           The product header data for connecting to the ConsumerCreateUnverifiedIHI service (Mandatory)
     ...
     */
    public ConsumerCreateUnverifiedIHIClient(final String serviceEndpoint,
    ...
    /**
     * Constructor which creates a new ConsumerCreateUnverifiedIHIClient with an endpoint and an SSL Socket Factory, with
     * the optional contracted service providers HPI-O organisation qualified ID set.
     *
     * @param serviceEndpoint         the Web Service endpoint for the Medicare HI Service interface (Mandatory)
     * @param individualQualifiedId The qualified user ID for connecting to the ConsumerCreateUnverifiedIHI service (Mandatory)
     * @param organisationQualifiedId The qualified organisation ID for connecting to the ConsumerCreateUnverifiedIHI service (Optional)
     * @param productHeader           The product header data for connecting to the ConsumerCreateUnverifiedIHI service (Mandatory)
     * @param signingPrivateKey       The private key to be used for signing (Mandatory)
     * @param signingCertificate      The certificate to be used for signing (Mandatory)
     * @param sslSocketFactory        the SSL Socket Factory to be used when connecting to the Web Service provider (Mandatory)
    ...
    public ConsumerCreateUnverifiedIHIClient(final String serviceEndpoint,
        ...
        super(ConsumerCreateUnverifiedIHIPortType.class,
                ConsumerCreateUnverifiedIHIService.class,
                individualQualifiedId,
    ...
    /**
     * Executes a Create Unverified IHI request.
     *
     * @param request the CreateUnverifiedIHI request body
     * @return the response from the ConsumerCreateUnverifiedIHI service
     * @throws StandardErrorMsg if the Web Service call fails.
     */
    public final CreateUnverifiedIHIResponse createUnverifiedIHI(CreateUnverifiedIHI request) throws StandardErrorMsg {
        ...
        return getPort().createUnverifiedIHI(
                request,
                productHolder,
                getTimestampHeader(),
                signatureHeader,
     ...
     * @throws StandardErrorMsg if the Web Service call fails.
     */
    public final CreateUnverifiedIHIResponse createUnverifiedIHI(
