...
import au.net.electronichealth.ns.hi.svc.consumercreateverifiedihi._4_0.ConsumerCreateVerifiedIHIPortType;
import au.net.electronichealth.ns.hi.svc.consumercreateverifiedihi._4_0.ConsumerCreateVerifiedIHIService;
import au.net.electronichealth.ns.hi.svc.consumercreateverifiedihi._4_0.CreateVerifiedIHI;
import au.net.electronichealth.ns.hi.svc.consumercreateverifiedihi._4_0.CreateVerifiedIHIResponse;
import au.net.electronichealth.ns.hi.svc.consumercreateverifiedihi._4_0.StandardErrorMsg;
...
/**
 * An implementation of a Healthcare Identifiers (HI) Individual Healthcare Identifier (IHI) create verified client.
 * This class may be used to connect to the Medicare HI Service for Consumer Create Verified IHI (4.0.0) operations.
 */
public class ConsumerCreateVerifiedIHIClient extends BaseClient_3<ConsumerCreateVerifiedIHIPortType> {

    /**
     * Constructor which creates a new ConsumerCreateVerifiedIHIClient with an endpoint and an SSL Socket Factory.
     *
     * @param serviceEndpoint         the Web Service endpoint for the Medicare HI Service interface (Mandatory)
     * @param individualQualifiedId   The qualified user ID for connecting to the ConsumerCreateVerifiedIHI service (Mandatory)
     * @param productHeader           The product header data for connecting to the ConsumerCreateVerifiedIHI service (Mandatory)
     ...
     */
    public ConsumerCreateVerifiedIHIClient(final String serviceEndpoint,
    ...
    /**
     * Constructor which creates a new ConsumerCreateVerifiedIHIClient with an endpoint and an SSL Socket Factory, with
     * the optional contracted service providers HPI-O organisation qualified ID set.
     *
     * @param serviceEndpoint         the Web Service endpoint for the Medicare HI Service interface (Mandatory)
     * @param individualQualifiedId The qualified user ID for connecting to the ConsumerCreateVerifiedIHI service (Mandatory)
     * @param organisationQualifiedId The qualified organisation ID for connecting to the ConsumerCreateVerifiedIHI service (Optional)
     * @param productHeader           The product header data for connecting to the ConsumerCreateVerifiedIHI service (Mandatory)
     * @param signingPrivateKey       The private key to be used for signing (Mandatory)
     * @param signingCertificate      The certificate to be used for signing (Mandatory)
     * @param sslSocketFactory        the SSL Socket Factory to be used when connecting to the Web Service provider (Mandatory)
    ...
    public ConsumerCreateVerifiedIHIClient(final String serviceEndpoint,
        ...
        super(ConsumerCreateVerifiedIHIPortType.class,
                ConsumerCreateVerifiedIHIService.class,
                individualQualifiedId,
    ...
    /**
     * Executes a Create Verified IHI request.
     *
     * @param request the CreateVerifiedIHI request body
     * @return the response from the ConsumerCreateVerifiedIHI service
     * @throws StandardErrorMsg if the Web Service call fails.
     */
    public final CreateVerifiedIHIResponse createVerifiedIHI(CreateVerifiedIHI request) throws StandardErrorMsg {
        ...
        return getPort().createVerifiedIHI(
                request,
                productHolder,
                getTimestampHeader(),
                signatureHeader,
     ...
     * @throws StandardErrorMsg if the Web Service call fails.
     */
    public final CreateVerifiedIHIResponse createVerifiedIHI(
