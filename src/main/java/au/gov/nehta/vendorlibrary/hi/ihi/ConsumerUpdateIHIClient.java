...
import au.net.electronichealth.ns.hi.svc.consumerupdateihi._3_2.ConsumerUpdateIHIPortType;
import au.net.electronichealth.ns.hi.svc.consumerupdateihi._3_2.ConsumerUpdateIHIService;
import au.net.electronichealth.ns.hi.svc.consumerupdateihi._3_2.StandardErrorMsg;
import au.net.electronichealth.ns.hi.svc.consumerupdateihi._3_2.UpdateIHI;
import au.net.electronichealth.ns.hi.svc.consumerupdateihi._3_2.UpdateIHIResponse;
...
/**
 * An implementation of a Healthcare Identifiers (HI) Individual Healthcare Identifier (IHI) update client.
 * This class may be used to connect to the Medicare HI Service for Consumer Update IHI (3.2.0) operations.
 */
public class ConsumerUpdateIHIClient extends BaseClient_3<ConsumerUpdateIHIPortType> {

    /**
     * Constructor which creates a new ConsumerUpdateIHIClient with an endpoint and an SSL Socket Factory.
     *
     * @param serviceEndpoint         the Web Service endpoint for the Medicare HI Service interface (Mandatory)
     * @param individualQualifiedId   The qualified user ID for connecting to the ConsumerUpdateIHI service (Mandatory)
     * @param productHeader           The product header data for connecting to the ConsumerUpdateIHI service (Mandatory)
     ...
     */
    public ConsumerUpdateIHIClient(final String serviceEndpoint,
    ...
    /**
     * Constructor which creates a new ConsumerUpdateIHIClient with an endpoint and an SSL Socket Factory, with
     * the optional contracted service providers HPI-O organisation qualified ID set.
     *
     * @param serviceEndpoint         the Web Service endpoint for the Medicare HI Service interface (Mandatory)
     * @param individualQualifiedId The qualified user ID for connecting to the ConsumerUpdateIHI service (Mandatory)
     * @param organisationQualifiedId The qualified organisation ID for connecting to the ConsumerUpdateIHI service (Optional)
     * @param productHeader           The product header data for connecting to the ConsumerUpdateIHI service (Mandatory)
     * @param signingPrivateKey       The private key to be used for signing (Mandatory)
     * @param signingCertificate      The certificate to be used for signing (Mandatory)
     * @param sslSocketFactory        the SSL Socket Factory to be used when connecting to the Web Service provider (Mandatory)
    ...
    public ConsumerUpdateIHIClient(final String serviceEndpoint,
        ...
        super(ConsumerUpdateIHIPortType.class,
                ConsumerUpdateIHIService.class,
                individualQualifiedId,
    ...
    /**
     * Executes an Update IHI request.
     *
     * @param request the UpdateIHI request body
     * @return the response from the ConsumerUpdateIHI service
     * @throws StandardErrorMsg if the Web Service call fails.
     */
    public final UpdateIHIResponse updateIHI(UpdateIHI request) throws StandardErrorMsg {
     ...
     * @throws StandardErrorMsg if the Web Service call fails.
     */
    public final UpdateIHIResponse updateIHI(UpdateIHI request,
