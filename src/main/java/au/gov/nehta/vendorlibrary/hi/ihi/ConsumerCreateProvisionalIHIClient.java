...
import au.net.electronichealth.ns.hi.svc.consumercreateprovisionalihi._3.ConsumerCreateProvisionalIHIPortType;
import au.net.electronichealth.ns.hi.svc.consumercreateprovisionalihi._3.ConsumerCreateProvisionalIHIService;
import au.net.electronichealth.ns.hi.svc.consumercreateprovisionalihi._3.CreateProvisionalIHI;
import au.net.electronichealth.ns.hi.svc.consumercreateprovisionalihi._3.CreateProvisionalIHIResponse;
import au.net.electronichealth.ns.hi.svc.consumercreateprovisionalihi._3.StandardErrorMsg;
...
/**
 * An implementation of a Healthcare Identifiers (HI) Individual Healthcare Identifier (IHI) create provisional client.
 * This class may be used to connect to the Medicare HI Service for Consumer Create Provisional IHI (3.0) operations.
 */
public class ConsumerCreateProvisionalIHIClient extends BaseClient_3<ConsumerCreateProvisionalIHIPortType> {

    /**
     * Constructor which creates a new ConsumerCreateProvisionalIHIClient with an endpoint and an SSL Socket Factory.
     *
     * @param serviceEndpoint         the Web Service endpoint for the Medicare HI Service interface (Mandatory)
     * @param individualQualifiedId   The qualified user ID for connecting to the ConsumerCreateProvisionalIHI service (Mandatory)
     * @param productHeader           The product header data for connecting to the ConsumerCreateProvisionalIHI service (Mandatory)
     ...
     */
    public ConsumerCreateProvisionalIHIClient(final String serviceEndpoint,
    ...
    /**
     * Constructor which creates a new ConsumerCreateProvisionalIHIClient with an endpoint and an SSL Socket Factory, with
     * the optional contracted service providers HPI-O organisation qualified ID set.
     *
     * @param serviceEndpoint         the Web Service endpoint for the Medicare HI Service interface (Mandatory)
     * @param individualQualifiedId The qualified user ID for connecting to the ConsumerCreateProvisionalIHI service (Mandatory)
     * @param organisationQualifiedId The qualified organisation ID for connecting to the ConsumerCreateProvisionalIHI service (Optional)
     * @param productHeader           The product header data for connecting to the ConsumerCreateProvisionalIHI service (Mandatory)
     * @param signingPrivateKey       The private key to be used for signing (Mandatory)
     * @param signingCertificate      The certificate to be used for signing (Mandatory)
     * @param sslSocketFactory        the SSL Socket Factory to be used when connecting to the Web Service provider (Mandatory)
    ...
    public ConsumerCreateProvisionalIHIClient(final String serviceEndpoint,
        ...
        super(ConsumerCreateProvisionalIHIPortType.class,
                ConsumerCreateProvisionalIHIService.class,
                individualQualifiedId,
    ...
    /**
     * Executes a Create Provisional IHI request.
     *
     * @param request the CreateProvisionalIHI request body
     * @return the response from the ConsumerCreateProvisionalIHI service
     * @throws StandardErrorMsg if the Web Service call fails.
     */
    public final CreateProvisionalIHIResponse createProvisionalIHI(CreateProvisionalIHI request) throws StandardErrorMsg {
        ...
        return getPort().createProvisionalIHI(
                request,
                productHolder,
                getTimestampHeader(),
                signatureHeader,
     ...
     * @throws StandardErrorMsg if the Web Service call fails.
     */
    public final CreateProvisionalIHIResponse createProvisionalIHI(
