...
public abstract class ClientBase<T> {
    ...
    /**
     * The Jakarta XML Web Services port for SOAP operations.
     */
    protected T port;
    /**
    ...
    /**
     * SSL socket factory class name for the EE4J XML-WS stack ({@code com.sun.xml.ws}) on the classpath.
     */
    ...
    protected static final String QUALIFIED_ID_MISSING = "individualQualifiedId must be supplied, construct the client with a individualQualifiedId or use the alternate request method to supply the qualifiedUserID per request";
    ...
    /** @return {@code true} if {@code s} is {@code null} or has length zero */
