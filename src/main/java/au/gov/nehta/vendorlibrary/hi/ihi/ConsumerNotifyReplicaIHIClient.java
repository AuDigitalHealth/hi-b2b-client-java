...
import au.net.electronichealth.ns.hi.svc.consumernotifyreplicaihi._3_2.ConsumerNotifyReplicaIHIPortType;
import au.net.electronichealth.ns.hi.svc.consumernotifyreplicaihi._3_2.ConsumerNotifyReplicaIHIService;
import au.net.electronichealth.ns.hi.svc.consumernotifyreplicaihi._3_2.NotifyReplicaIHI;
import au.net.electronichealth.ns.hi.svc.consumernotifyreplicaihi._3_2.NotifyReplicaIHIResponse;
import au.net.electronichealth.ns.hi.svc.consumernotifyreplicaihi._3_2.StandardErrorMsg;
...
/**
 * An implementation of a Healthcare Identifiers (HI) Individual Healthcare Identifier (IHI) notify replica client.
 * This class may be used to connect to the Medicare HI Service for Consumer Notify Replica IHI (3.2.0) operations.
 */
public class ConsumerNotifyReplicaIHIClient extends BaseClient_3<ConsumerNotifyReplicaIHIPortType> {

    /**
     * Constructor which creates a new ConsumerNotifyReplicaIHIClient with an endpoint and an SSL Socket Factory.
     *
     * @param serviceEndpoint         the Web Service endpoint for the Medicare HI Service interface (Mandatory)
     * @param individualQualifiedId   The qualified user ID for connecting to the ConsumerNotifyReplicaIHI service (Mandatory)
     * @param productHeader           The product header data for connecting to the ConsumerNotifyReplicaIHI service (Mandatory)
     ...
     */
    public ConsumerNotifyReplicaIHIClient(final String serviceEndpoint,
    ...
    /**
     * Constructor which creates a new ConsumerNotifyReplicaIHIClient with an endpoint and an SSL Socket Factory, with
     * the optional contracted service providers HPI-O organisation qualified ID set.
     *
     * @param serviceEndpoint         the Web Service endpoint for the Medicare HI Service interface (Mandatory)
     * @param individualQualifiedId The qualified user ID for connecting to the ConsumerNotifyReplicaIHI service (Mandatory)
     * @param organisationQualifiedId The qualified organisation ID for connecting to the ConsumerNotifyReplicaIHI service (Optional)
     * @param productHeader           The product header data for connecting to the ConsumerNotifyReplicaIHI service (Mandatory)
     * @param signingPrivateKey       The private key to be used for signing (Mandatory)
     * @param signingCertificate      The certificate to be used for signing (Mandatory)
     * @param sslSocketFactory        the SSL Socket Factory to be used when connecting to the Web Service provider (Mandatory)
    ...
    public ConsumerNotifyReplicaIHIClient(final String serviceEndpoint,
        ...
        super(ConsumerNotifyReplicaIHIPortType.class,
                ConsumerNotifyReplicaIHIService.class,
                individualQualifiedId,
    ...
    /**
     * Executes a Notify Replica IHI request.
     *
     * @param request the NotifyReplicaIHI request body
     * @return the response from the ConsumerNotifyReplicaIHI service
     * @throws StandardErrorMsg if the Web Service call fails.
     */
    public final NotifyReplicaIHIResponse notifyReplicaIHI(NotifyReplicaIHI request) throws StandardErrorMsg {
        ...
        return getPort().notifyReplicaIHI(
                request,
                productHolder,
                getTimestampHeader(),
                signatureHeader,
     ...
     * @throws StandardErrorMsg if the Web Service call fails.
     */
    public final NotifyReplicaIHIResponse notifyReplicaIHI(
