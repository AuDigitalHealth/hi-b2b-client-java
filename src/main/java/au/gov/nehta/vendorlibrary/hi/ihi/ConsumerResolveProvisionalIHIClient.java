...
import au.net.electronichealth.ns.hi.svc.consumerresolveprovisionalihi._3_0.ConsumerResolveProvisionalIHIPortType;
import au.net.electronichealth.ns.hi.svc.consumerresolveprovisionalihi._3_0.ConsumerResolveProvisionalIHIService;
import au.net.electronichealth.ns.hi.svc.consumerresolveprovisionalihi._3_0.ResolveProvisionalIHI;
import au.net.electronichealth.ns.hi.svc.consumerresolveprovisionalihi._3_0.ResolveProvisionalIHIResponse;
import au.net.electronichealth.ns.hi.svc.consumerresolveprovisionalihi._3_0.StandardErrorMsg;
...
/**
 * An implementation of a Healthcare Identifiers (HI) Individual Healthcare Identifier (IHI) resolve provisional client.
 * This class may be used to connect to the Medicare HI Service for Consumer Resolve Provisional IHI (3.0.2) operations.
 */
public class ConsumerResolveProvisionalIHIClient extends BaseClient_3<ConsumerResolveProvisionalIHIPortType> {

    /**
     * Constructor which creates a new ConsumerResolveProvisionalIHIClient with an endpoint and an SSL Socket Factory.
     *
     * @param serviceEndpoint         the Web Service endpoint for the Medicare HI Service interface (Mandatory)
     * @param individualQualifiedId   The qualified user ID for connecting to the ConsumerResolveProvisionalIHI service (Mandatory)
     * @param productHeader           The product header data for connecting to the ConsumerResolveProvisionalIHI service (Mandatory)
     ...
     */
    public ConsumerResolveProvisionalIHIClient(final String serviceEndpoint,
    ...
    /**
     * Constructor which creates a new ConsumerResolveProvisionalIHIClient with an endpoint and an SSL Socket Factory, with
     * the optional contracted service providers HPI-O organisation qualified ID set.
     *
     * @param serviceEndpoint         the Web Service endpoint for the Medicare HI Service interface (Mandatory)
     * @param individualQualifiedId The qualified user ID for connecting to the ConsumerResolveProvisionalIHI service (Mandatory)
     * @param organisationQualifiedId The qualified organisation ID for connecting to the ConsumerResolveProvisionalIHI service (Optional)
     * @param productHeader           The product header data for connecting to the ConsumerResolveProvisionalIHI service (Mandatory)
     * @param signingPrivateKey       The private key to be used for signing (Mandatory)
     * @param signingCertificate      The certificate to be used for signing (Mandatory)
     * @param sslSocketFactory        the SSL Socket Factory to be used when connecting to the Web Service provider (Mandatory)
    ...
    public ConsumerResolveProvisionalIHIClient(final String serviceEndpoint,
        ...
        super(ConsumerResolveProvisionalIHIPortType.class,
                ConsumerResolveProvisionalIHIService.class,
                individualQualifiedId,
    ...
    /**
     * Executes a Resolve Provisional IHI request.
     *
     * @param request the ResolveProvisionalIHI request body
     * @return the response from the ConsumerResolveProvisionalIHI service
     * @throws StandardErrorMsg if the Web Service call fails.
     */
    public final ResolveProvisionalIHIResponse resolveProvisionalIHI(ResolveProvisionalIHI request)
        ...
        return getPort().resolveProvisionalIHI(
                request,
                productHolder,
                getTimestampHeader(),
                signatureHeader,
     ...
     * @throws StandardErrorMsg if the Web Service call fails.
     */
    public final ResolveProvisionalIHIResponse resolveProvisionalIHI(
