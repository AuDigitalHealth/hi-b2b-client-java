...
public class ConsumerResolveProvisionalIHIClientTest {

    @Test
    public void bindingProviderIsNotNull() throws Exception {
        ConsumerResolveProvisionalIHIClient tc = getMedicareTestClient();
    ...
    public void testNullLoggingHandler() throws Exception {
        ...
        ConsumerResolveProvisionalIHIClient testClient = getMedicareTestClient();
    ...
    public void resolveProvisionalIHI_nullRequest_clientUser() throws Exception {
        getMedicareTestClient().resolveProvisionalIHI(null);
    }

    @Test(expected = IllegalArgumentException.class)
    public void resolveProvisionalIHI_nullRequest_perRequestUser() throws Exception {
        getMedicareTestClient().resolveProvisionalIHI(null, getWrappedUserQualifiedId());
    }

    private ConsumerResolveProvisionalIHIClient getMedicareTestClient() throws GeneralSecurityException, IOException {
        return new ConsumerResolveProvisionalIHIClient(
