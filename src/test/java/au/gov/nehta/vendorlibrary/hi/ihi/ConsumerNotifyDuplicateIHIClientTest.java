...
public class ConsumerNotifyDuplicateIHIClientTest {

    @Test
    public void bindingProviderIsNotNull() throws Exception {
        ConsumerNotifyDuplicateIHIClient tc = getMedicareTestClient();
    ...
    public void testNullLoggingHandler() throws Exception {
        ...
        ConsumerNotifyDuplicateIHIClient testClient = getMedicareTestClient();
    ...
    public void notifyDuplicateIHI_nullRequest_clientUser() throws Exception {
        getMedicareTestClient().notifyDuplicateIHI(null);
    }

    @Test(expected = IllegalArgumentException.class)
    public void notifyDuplicateIHI_nullRequest_perRequestUser() throws Exception {
        getMedicareTestClient().notifyDuplicateIHI(null, getWrappedUserQualifiedId());
    }

    private ConsumerNotifyDuplicateIHIClient getMedicareTestClient() throws GeneralSecurityException, IOException {
        return new ConsumerNotifyDuplicateIHIClient(
