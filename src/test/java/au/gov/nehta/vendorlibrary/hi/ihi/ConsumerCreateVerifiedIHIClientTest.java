...
public class ConsumerCreateVerifiedIHIClientTest {

    @Test
    public void bindingProviderIsNotNull() throws Exception {
        ConsumerCreateVerifiedIHIClient tc = getMedicareTestClient();
    ...
    public void testNullLoggingHandler() throws Exception {
        ...
        ConsumerCreateVerifiedIHIClient testClient = getMedicareTestClient();
    ...
    public void createVerifiedIHI_nullRequest_clientUser() throws Exception {
        getMedicareTestClient().createVerifiedIHI(null);
    }

    @Test(expected = IllegalArgumentException.class)
    public void createVerifiedIHI_nullRequest_perRequestUser() throws Exception {
        getMedicareTestClient().createVerifiedIHI(null, getWrappedUserQualifiedId());
    }

    private ConsumerCreateVerifiedIHIClient getMedicareTestClient() throws GeneralSecurityException, IOException {
        return new ConsumerCreateVerifiedIHIClient(
