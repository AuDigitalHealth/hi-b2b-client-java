...
public class ConsumerCreateUnverifiedIHIClientTest {

    @Test
    public void bindingProviderIsNotNull() throws Exception {
        ConsumerCreateUnverifiedIHIClient tc = getMedicareTestClient();
    ...
    public void testNullLoggingHandler() throws Exception {
        ...
        ConsumerCreateUnverifiedIHIClient testClient = getMedicareTestClient();
    ...
    public void createUnverifiedIHI_nullRequest_clientUser() throws Exception {
        getMedicareTestClient().createUnverifiedIHI(null);
    }

    @Test(expected = IllegalArgumentException.class)
    public void createUnverifiedIHI_nullRequest_perRequestUser() throws Exception {
        getMedicareTestClient().createUnverifiedIHI(null, getWrappedUserQualifiedId());
    }

    private ConsumerCreateUnverifiedIHIClient getMedicareTestClient() throws GeneralSecurityException, IOException {
        return new ConsumerCreateUnverifiedIHIClient(
