...
public class ConsumerUpdateProvisionalIHIClientTest {

    @Test
    public void bindingProviderIsNotNull() throws Exception {
        ConsumerUpdateProvisionalIHIClient tc = getMedicareTestClient();
    ...
    public void testNullLoggingHandler() throws Exception {
        ...
        ConsumerUpdateProvisionalIHIClient testClient = getMedicareTestClient();
    ...
    public void updateProvisionalIHI_nullRequest_clientUser() throws Exception {
        getMedicareTestClient().updateProvisionalIHI(null);
    }

    @Test(expected = IllegalArgumentException.class)
    public void updateProvisionalIHI_nullRequest_perRequestUser() throws Exception {
        getMedicareTestClient().updateProvisionalIHI(null, getWrappedUserQualifiedId());
    }

    private ConsumerUpdateProvisionalIHIClient getMedicareTestClient() throws GeneralSecurityException, IOException {
        return new ConsumerUpdateProvisionalIHIClient(
