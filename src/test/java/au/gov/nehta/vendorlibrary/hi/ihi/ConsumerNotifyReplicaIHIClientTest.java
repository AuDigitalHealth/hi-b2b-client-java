...
public class ConsumerNotifyReplicaIHIClientTest {

    @Test
    public void bindingProviderIsNotNull() throws Exception {
        ConsumerNotifyReplicaIHIClient tc = getMedicareTestClient();
    ...
    public void testNullLoggingHandler() throws Exception {
        ...
        ConsumerNotifyReplicaIHIClient testClient = getMedicareTestClient();
    ...
    public void notifyReplicaIHI_nullRequest_clientUser() throws Exception {
        getMedicareTestClient().notifyReplicaIHI(null);
    }

    @Test(expected = IllegalArgumentException.class)
    public void notifyReplicaIHI_nullRequest_perRequestUser() throws Exception {
        getMedicareTestClient().notifyReplicaIHI(null, getWrappedUserQualifiedId());
    }

    private ConsumerNotifyReplicaIHIClient getMedicareTestClient() throws GeneralSecurityException, IOException {
        return new ConsumerNotifyReplicaIHIClient(
