...
public class ConsumerUpdateIHIClientTest {

    @Test
    public void bindingProviderIsNotNull() throws Exception {
        ConsumerUpdateIHIClient tc = getMedicareTestClient();
    ...
    public void testNullLoggingHandler() throws Exception {
        ...
        ConsumerUpdateIHIClient testClient = getMedicareTestClient();
    ...
    public void updateIHI_nullRequest_clientUser() throws Exception {
        getMedicareTestClient().updateIHI(null);
    }

    @Test(expected = IllegalArgumentException.class)
    public void updateIHI_nullRequest_perRequestUser() throws Exception {
        getMedicareTestClient().updateIHI(null, getWrappedUserQualifiedId());
    }

    private ConsumerUpdateIHIClient getMedicareTestClient() throws GeneralSecurityException, IOException {
        return new ConsumerUpdateIHIClient(
