...
public class ProviderSearchTdsProviderIndividualClientTest {

    @Test
    public void bindingProviderIsNotNull() throws Exception {
        ProviderSearchTdsProviderIndividualClient tc = getMedicareTestClient();
    ...
    public void testNullLoggingHandler() throws Exception {
        ...
        ProviderSearchTdsProviderIndividualClient testClient = getMedicareTestClient();
    ...
    public void searchTdsProviderIndividual_nullRequest_clientUser() throws Exception {
        getMedicareTestClient().searchTdsProviderIndividual(null);
    }

    @Test(expected = IllegalArgumentException.class)
    public void searchTdsProviderIndividual_nullRequest_perRequestUser() throws Exception {
        getMedicareTestClient().searchTdsProviderIndividual(null, getWrappedUserQualifiedId());
    }

    private ProviderSearchTdsProviderIndividualClient getMedicareTestClient() throws GeneralSecurityException, IOException {
        return new ProviderSearchTdsProviderIndividualClient(
