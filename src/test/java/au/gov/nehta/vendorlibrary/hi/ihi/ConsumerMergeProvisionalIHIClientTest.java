...
public class ConsumerMergeProvisionalIHIClientTest {

    @Test
    public void bindingProviderIsNotNull() throws Exception {
        ConsumerMergeProvisionalIHIClient tc = getMedicareTestClient();
    ...
    public void testNullLoggingHandler() throws Exception {
        ...
        ConsumerMergeProvisionalIHIClient testClient = getMedicareTestClient();
    ...
    public void mergeProvisionalIHI_nullRequest_clientUser() throws Exception {
        getMedicareTestClient().mergeProvisionalIHI(null);
    }

    @Test(expected = IllegalArgumentException.class)
    public void mergeProvisionalIHI_nullRequest_perRequestUser() throws Exception {
        getMedicareTestClient().mergeProvisionalIHI(null, getWrappedUserQualifiedId());
    }

    private ConsumerMergeProvisionalIHIClient getMedicareTestClient() throws GeneralSecurityException, IOException {
        return new ConsumerMergeProvisionalIHIClient(
