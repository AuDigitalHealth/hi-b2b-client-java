...
public class IHITestConstants {
    ...
    public static final String VENDOR_QUALIFIER_ID = "TAS00001";
    ...
    public static final String MEDICARE_GENERIC_TEST_INDIVIDUAL_INTERNATIONAL_ADDRESS_INTERNATIONAL_ADDRESS_COUNTRY = "1";
    ...
    public static final String DRP_TEST_INDIVIDUAL_INTERNATIONAL_ADDRESS_INTERNATIONAL_ADDRESS_COUNTRY = "1";
