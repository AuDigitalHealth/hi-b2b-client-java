...
For Consumer Search IHI Interface WSDL (**`HI_ConsumerSearchIHIInterface-3.0`**), request XML places optional **`electronicCommunication`** before **`dateOfBirth`** and **`australianUnstructuredStreetAddress`** before **`internationalAddress`**.
